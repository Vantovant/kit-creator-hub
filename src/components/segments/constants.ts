...
export const FIELD_DEFINITIONS: FieldDef[] = [
  ...
  { value: "full_name", label: "Full Name", type: "text", category: "Contact" },
  { value: "phone_number", label: "Phone", type: "text", category: "Contact" },
  ...
  { value: "lead_type", label: "Lead Type", type: "text", category: "CRM" },
  { value: "registration_status", label: "Registration Status", type: "text", category: "CRM" },
  { value: "go_status", label: "GO Status", type: "text", category: "CRM" },
  { value: "associate_status", label: "Associate Status", type: "text", category: "CRM" },
  { value: "communication_status", label: "Communication Status", type: "text", category: "CRM" },
  { value: "lead_temperature", label: "Lead Temperature", type: "text", category: "CRM" },
  { value: "city", label: "City", type: "text", category: "Location" },
  { value: "province", label: "Province", type: "text", category: "Location" },
  { value: "state", label: "State", type: "text", category: "Location" },
  { value: "country", label: "Country", type: "text", category: "Location" },
  { value: "sponsor_name", label: "Sponsor", type: "text", category: "CRM" },
  { value: "assigned_to", label: "Assigned To", type: "text", category: "CRM" },
  { value: "aplgo_id", label: "APLGO ID", type: "text", category: "CRM" },
  ...
  { value: "date_captured", label: "Date Captured", type: "date", category: "Dates" },
  { value: "meeting_time", label: "Meeting Time", type: "date", category: "Dates" },
